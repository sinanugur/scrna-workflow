...
p2 <- FeaturePlot(scrna, features = "Total log2-UMI (Microbiome)", pt.size = 0.1, reduction = opt$reduction.type) & scale_color_continuous(type = "viridis") & theme(plot.title = element_blank())
