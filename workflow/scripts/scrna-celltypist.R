...
option_list = list(
    ...
    optparse::make_option(c("--rds"), type="character", default=NULL, 
        ...
        optparse::make_option(c("--output.tsne.plot"), type="character", default=NULL, 
              help="Output tsne file name", metavar="character"),
      optparse::make_option(c("--output.umap.plot"), type="character", default=NULL, 
...
scrna@meta.data <- scrna@meta.data %>% tibble::rownames_to_column("barcodes") %>% 
